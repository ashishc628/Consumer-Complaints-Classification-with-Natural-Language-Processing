...
app = FastAPI(title="Consumer Complaints Model API",
    description="A simple API that use NLP model to predict the classes of consumer complaints ",
    version="0.1",)
...
def greeting(text:str):
    return {"Hi {} welcome to Consumer Complaints Analysis".format(text)}
...
def Predict_Sentiment(item:Text):
    ...
    # output dictionary
    sentiments = {1: "credit_reporting ", 2: "debt_collection ",3: "mortgages_and_loans ",4: "credit_card",5: "retail_banking"}
